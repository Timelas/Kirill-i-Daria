  ...
  return (
    <section className="timetable" id="plan">
      ...
      <div className="timetable__block">
        ...
        <p className="timetable__text timetable__text_about_rings">Сбор гостей у метро <br /> 14.00</p>
        <p className="timetable__text timetable__text_about_foto">Транфер до ресторана "Панорама" <br /> 14.20</p>
        <p className="timetable__text timetable__text_about_glasses">Welcome Фуршет 15:00</p>
        <p className="timetable__text timetable__text_about_plate">Праздничный ужин <br /> 16.40</p>
