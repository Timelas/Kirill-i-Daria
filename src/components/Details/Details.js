...
о том, чтобы провести этот вечер без детей.</p>
      ...
      <div className="details__text">Если вы подготовили для нас сюрприз или творческий подарок, не забудьте предупредить нашего ведущего <div className="details__contact">Игоря: +7 981 132 47 88</div>. Он поможет воплотить вашу идею или отговорит вас, также ответит на все вопросы. </div>
      <div className="details__line"></div>
